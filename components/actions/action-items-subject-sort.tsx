...
export type SubjectSortOrder = 'asc' | 'desc' | null;

export interface ActionItemsSubjectSortState {
  sortOrder: SubjectSortOrder;
}

export function getDefaultActionItemsSubjectSort(): ActionItemsSubjectSortState {
  return { sortOrder: null };
}

interface ActionItemsSubjectSortDropdownProps {
  anchorRect: DOMRect | null;
  isOpen: boolean;
  onClose: () => void;
  filter: ActionItemsSubjectSortState;
  onFilterChange: (filter: ActionItemsSubjectSortState) => void;
  onApply: () => void;
  onReset: () => void;
  hasChanges?: boolean;
...
export function ActionItemsSubjectSortDropdown({
  anchorRect,
  isOpen,
  onClose,
  filter,
...
}: ActionItemsSubjectSortDropdownProps) {
